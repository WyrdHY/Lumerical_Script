...
:: Set the repository path to your target folder
set REPO_PATH=D:\Caltech\Lumerical_Simulation\Script
...
set REMOTE_REPO=https://github.com/WyrdHY/Lumerical_Script
